        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {stories.map((story) => (
            <tr key={story.id}>
              ...
              <td className="font-medium text-gray-900 max-w-48 overflow-hidden">{story.title}</td>
              ...
              <td>
                <span className={`px-2 py-1 text-xs rounded-full ${getStatusClass(story.status)}`}>{story.status}</span>
              </td>
              <td>
