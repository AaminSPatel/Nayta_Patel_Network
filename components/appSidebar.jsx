        ...
        {!isAdmin && !isPWA && deferredPrompt && (
          <div className="-mt-2">
            <button
              ...
              className="w-full bg-yellow-400 hover:bg-amber-500 flex items-center justify-center gap-2 text-white py-2 px-4 rounded-md transition-colors"
            >
              Install Our App <MdInstallMobile />
            </button>
          </div>
        )}
      </aside>
